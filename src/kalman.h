...
private:
    ...
    Matrix<double, 7, 1> x_aug;     // augmented state (+ [q_a, q_wd])
    ...
    Matrix<double, 7, 15> Xsig_aug; // augmented sigma points
    Matrix<double, 5, 15> Xsig_pred;// predicted sigma points
    Matrix<double, 4, 15> Zsig_pred;// predicted measuremenmts
    Matrix<double, 15, 1> weights;  // sigma points weights
    Matrix<double, 4, 1> z;         // input measurement
    Matrix<double, 4, 1> z_pred;    // predicted measurement
